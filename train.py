...
train_loader = torch.utils.data.DataLoader(train, batch_size=24, num_workers=1, shuffle=True, pin_memory=True)
test = MVSEC(mvsec_path)
test_loader = torch.utils.data.DataLoader(test, batch_size=24, num_workers=1, shuffle=True, pin_memory=True)
